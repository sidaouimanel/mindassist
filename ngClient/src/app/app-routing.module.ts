...
const routes: Routes = [
  ...
  { path: 'meet-friends', component: MeetFriendsComponent },
  { path: 'relaxation', component: RelaxationActivityComponent },
  { path: 'home', component: HomeComponent },
  { path: 'chatbot', component: ChatbotComponent },
  { path: 'news', component: NewsComponent },
  { path: 'posts', component: PostsComponent},
  { path: 'posts/add', component: CreatePostComponent, canActivate:[AdminGuardGuard] },
  { path: 'posts/update/:id', component: UpdatePostComponent },
  { path: 'posts/:id', component: PostDetailsComponent, canActivate:[AdminGuardGuard] },
  { path: 'posts/:id/add', component: CreateCommentComponent, canActivate:[AdminGuardGuard] },
